    ...
    : ModSystemFeature<UiTweaksModSystem, ZoomConfig>(modSystem, config), IRenderer
{
    ...
    public override void Dispose()
    {
        ...
        {
            ModHotKeys.Zoom.Unregister(_clientApi.Input);
    ...
    private void UpdateHotKeyRegistration()
    {
        if (Config.Enable)
        {
            ...
            _clientApi!.Input.AddHotKey(ModHotKeys.Zoom, HandleZoomHotKey);
            _clientApi.Input.GetHotKeyByCode(ModHotKeys.Zoom.Code).TriggerOnUpAlso = true;
    ...
    private bool HandleZoomHotKey(KeyCombination mapping)
    {
