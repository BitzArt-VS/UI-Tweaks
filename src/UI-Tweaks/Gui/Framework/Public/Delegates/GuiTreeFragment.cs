...
/// <summary>
/// Declares a subtree of nodes via <paramref name="builder"/>.
...
/// <summary>
/// Parameterised counterpart to <see cref="GuiTreeFragment"/> — declares a subtree
/// driven by a single <typeparamref name="T"/> argument. Used by templated components
/// (e.g. <see cref="GuiDropdown{T}"/>) to let callers declare a single item.
/// <para>
...
/// <c>delegate void(IGuiTreeBuilder, T)</c> instead: invoking the template requires
