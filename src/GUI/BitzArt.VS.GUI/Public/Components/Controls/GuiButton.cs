...
/// <see cref="OnClick"/> property typed as <see cref="GuiCallback"/>.
/// </para>
/// <para>
...
public sealed class GuiButton : GuiComponent
{
    ...
    /// <summary>Work invoked after a successful click. <see langword="null"/> means no
    /// handler.</summary>
    ...
    {
        if (!Enabled || OnClick is not GuiCallback onClick)
        {
            return;
        }
