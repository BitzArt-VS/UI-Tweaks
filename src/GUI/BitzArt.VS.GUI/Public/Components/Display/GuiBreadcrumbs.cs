...
public class GuiBreadcrumbs : GuiBreadcrumbs<string>
{
    ...
    private void BuildStringItem(IGuiTreeBuilder builder, string text)
    {
        ...
        builder.Add<GuiContainer>(0)
            ...
            .OnMouseEnter((Action<GuiMouseEventArgs>)(_ => EnterItemHover(capturedIndex)))
            .OnMouseLeave((Action<GuiMouseEventArgs>)(_ => LeaveItemHover(capturedIndex)))
            .OnMouseClick((Action<GuiMouseEventArgs>)(_ => OnItemClicked?.Invoke(text)));
    }
