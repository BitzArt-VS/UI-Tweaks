...
public static class GuiTreeBuilderExtensions
{
    ...
    public static IGuiTreeBuilder<GuiDialogTitleBar> AddDialogTitleBar(
        ...
        GuiCallback? onClose = null)
        => AddDialogTitleBarCore(builder, key, title, titleFont, onDrag, onClose);
    ...
    /// <summary>
    /// Declares a <see cref="GuiButton"/> slot at <paramref name="key"/> and optionally
    /// assigns its <see cref="GuiButton.OnClick"/> callback.
    /// </summary>
    public static IGuiTreeBuilder<GuiButton> AddButton(
        this IGuiTreeBuilder builder,
        int key,
        string text,
        GuiCallback? onClick = null)
    ...
    /// <summary>Assigns <see cref="GuiButton.OnClick"/>.</summary>
    public static IGuiTreeBuilder<GuiButton> OnClick(this IGuiTreeBuilder<GuiButton> builder, GuiCallback callback)
        => builder.Configure(button => button.OnClick = callback);
