...
|                                                                |
|----------------------------------------------------------------|
| ![tooltip-labels-showcase](assets/tooltip-labels-showcase.png) |
| ![tooltip-labels-config](assets/tooltip-labels-config.png)     |
...
|                                                                |
|----------------------------------------------------------------|
| ![quick-search-showcase](assets/quick-search-showcase.png)     |
...
|                                                                |
|----------------------------------------------------------------|
| ![calculator-showcase](assets/calculator-showcase.png)     |
