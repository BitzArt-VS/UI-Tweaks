...
<div class="carousel">
  <input type="radio" name="tooltips" id="tooltips-s1" checked>
  <input type="radio" name="tooltips" id="tooltips-s2">

  <div class="carousel-body">
    <div class="carousel-arrow-area carousel-prev-area">
      <span class="arrow-symbol">&#10094;</span>
      <label class="carousel-arrow ctrl-1" for="tooltips-s2"></label>
      <label class="carousel-arrow ctrl-2" for="tooltips-s1"></label>
    </div>
  ...
  <div class="carousel-dots">
    <label class="carousel-dot" for="tooltips-s1"></label>
    <label class="carousel-dot" for="tooltips-s2"></label>
  </div>
</div>
...
<div class="image-showcase">
  <img src="assets/quick-search-showcase.png" alt="Quick Search Showcase">
</div>
...
<div class="image-showcase">
  <img src="assets/calculator-showcase.png" alt="Calculator Showcase">
</div>
